...
def main():
    ...
    df3['planovoye'] = df3['planovoye'].replace('', '0').astype(int)
    df3['Batteries V4.6'] = df3['Batteries V4.6'].replace('', '0').astype(int)
    df3['Batteries numbers V3 PRO'] = df3['Batteries numbers V3 PRO'].replace('', '0').astype(int)
