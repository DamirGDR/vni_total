...
def main():
    ...
    #                                 tbu.bid
    #                             FROM damir.t_bike_use tbu
    #                             WHERE tbu.ride_status!=5 AND to_timestamp(tbu."date")::date = current_date - INTERVAL '1 days')
    #         GROUP BY tb.city_id
    #     ),
    ...
    #         SELECT
    #             tb.city_id ,
    #             COUNT(tb.id) AS uteryany
    #         FROM damir.t_bike tb
    #         WHERE tb.error_status = 6
    #         GROUP BY tb.city_id
    #     ),
    ...
    #                                 tbu.bid
    #                             FROM damir.t_bike_use tbu
    #                             WHERE tbu.ride_status!=5 AND to_timestamp(tbu."date")::date >= current_date - INTERVAL '1 month')
    ...
    #         --COALESCE(vni.srednyaa_stoimost_minute,0) AS srednyaa_stoimost_minute,
    #         --COALESCE(vni.srednyaa_cena_poezdki,0) AS srednyaa_cena_poezdki,
    ...
    truncate_t_parking_revenue_stats = '''DELETE FROM damir.t_parking_revenue_stats 
       WHERE damir.t_parking_revenue_stats."timestamp" >= CURRENT_DATE
    ...
    print('Количество записей к удалению в parking_count_revenue: {}'.format(df_parking_count1.iloc[0].iloc[0]))
    ...
    truncate_t_parking_kvt = '''DELETE FROM damir.t_parking_kvt 
       WHERE damir.t_parking_kvt."timestamp" >= CURRENT_DATE
    ...
    print('Количество записей к удалению в parking_count_revenue: {}'.format(df_parking_count.iloc[0].iloc[0]))
    # Проверка количества строк. Конец
