...
def main():
    ...
    df_grafik_rabot['Planned start time'] = pd.to_datetime(df_grafik_rabot['Planned start time'], errors='coerce').replace('1970-01-01',
                                                                                                          'NaT')
    df_grafik_rabot['Planned finish time'] = pd.to_datetime(df_grafik_rabot['Planned finish time'], errors='coerce').replace(
        '1970-01-01', 'NaT')
    df_grafik_rabot['Actual start time'] = pd.to_datetime(df_grafik_rabot['Actual start time'], errors='coerce').replace('1970-01-01',
                                                                                                        'NaT')
    df_grafik_rabot['Actual finish time'] = pd.to_datetime(df_grafik_rabot['Actual finish time'], errors='coerce').replace('1970-01-01',
                                                                                                          'NaT')
