...
def main():
    ...
    select_df_parking_count1 = '''
           ...
           WHERE damir.t_parking_revenue_stats."timestamp" >= CURRENT_DATE - INTERVAL '1 hour'
                  AND damir.t_parking_revenue_stats."timestamp" <= NOW() + INTERVAL '1 hour'
       '''
            ...
            FROM 
                ...
                FROM 
                    ...
                    WHERE tbh.error_status IN (0,7)
                        AND tbh."timestamp" >= CURRENT_DATE + INTERVAL '1 hour'
    ...
    select_df_parking_count = '''
            ...
            WHERE damir.t_parking_kvt."timestamp" >= CURRENT_DATE - INTERVAL '1 hour'
                   AND damir.t_parking_kvt."timestamp" <= NOW() + INTERVAL '1 hour' 
        '''
