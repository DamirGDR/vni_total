...
def main():
                ...
                CASE
                    WHEN ds."nomer_decada" IN (1,2) THEN 
                        CASE 
                            ...
                            ELSE ds."Actual duration (hours)" * 60 / (CURRENT_DATE - ds."decade" + 1) * 10
                        END
                        ...
                        CASE 
                            WHEN EXTRACT(MONTH FROM ds."decade") IN (1,3,5,7,8,10,12) THEN 
                                CASE
                                    ...
                                    ELSE ds."Actual duration (hours)" * 60 / (CURRENT_DATE - ds."decade" + 1) * ds."kol_vo_dney_3_decada"
                                END
    ...
    select_fresh_parking_stats = '''
        ...
        --LEFT JOIN damir.t_city tc ON COALESCE(t_starts_res.city_id, t_ends_res.city_id) = tc.id
